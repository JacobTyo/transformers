...
# TODO: Change headers, locations, and commits
...
METAGPT2_PRETRAINED_CONFIG_ARCHIVE_MAP = {
...
# TODO: I am not sure if PretrainedConfig needs changed or not, hopefuly not else this gets very rough
class MetaGPT2Config(PretrainedConfig):
    """
    TODO: Fix this
    ...
    pretrained_config_archive_map = METAGPT2_PRETRAINED_CONFIG_ARCHIVE_MAP
    model_type = "metagpt2"
